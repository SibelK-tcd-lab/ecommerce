...
import { addToCart } from '../store/actions/shoppingCartActions'; // Aksiyonu import ettik
...
const ProductDetails = () => {
  ...
  // TAMİR EDİLDİ: addToCart aksiyon yaratıcısını kullanarak veri gönderiyoruz
        ...
        <div className="flex flex-col space-y-8">
          ...
          <div className="flex gap-4 pt-4">
            <button 
              ...
              className="flex-1 border-2 border-[#23A6F0] text-[#23A6F0] py-4 rounded-md font-bold uppercase hover:bg-[#23A6F0] hover:text-white transition-all shadow-sm active:scale-95"
            >
              Add to Cart
            </button>
            <button 
